...
/*!
 * the path to use for the NetBSD HDMI CEC device
 */
#define CEC_NETBSD_PATH		"/dev/hdmicec0"

/*!
 * the name of the virtual COM port to use for the NetBSD API's CEC wire
 */
#define CEC_NETBSD_VIRTUAL_COM		"NetBSD"
