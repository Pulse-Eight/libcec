#pragma once
/*
 * This file is part of libCEC(R) library.
 *
  ...
  class CAdapterMessageQueueEntry
  {
    public:
      ...
      bool Wait(uint32_t iTimeout)
      {
        ...
        bool bReturn = m_bSucceeded ? true : m_condition.Wait(m_mutex, m_bSuccessed, iTimeout);
        m_bWaiting = false;
        return bReturn;
      }
       ...
       */
      static uint32_t hashValue(uint_t opcode,
