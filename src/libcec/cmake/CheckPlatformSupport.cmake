...
#       HAVE_MACOS_API            ON if MacOS is supported
...
SET(HAVE_MACOS_API       OFF CACHE BOOL "macos not supported")
...
if(WIN32)
  ...
  # MacOS
  if (${HAVE_MACOS_API})
    set(LIB_INFO "${LIB_INFO}, MacOS")
    SET(HAVE_MACOS_API ON CACHE BOOL "MacOS supported" FORCE)
    set(CEC_SOURCES_ADAPTER_MACOS adapter/MacOS/DisplayPortAux.cpp
                                  adapter/MacOS/MacOSCECAdapterDetection.cpp
                                  adapter/MacOS/MacOSCECAdapterCommunication.cpp)
    source_group("Source Files\\adapter\\MacOS" FILES ${CEC_SOURCES_ADAPTER_MACOS})
    list(APPEND CEC_SOURCES ${CEC_SOURCES_ADAPTER_MACOS})
  endif()
