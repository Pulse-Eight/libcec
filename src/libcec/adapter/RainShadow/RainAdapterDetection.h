...
namespace CEC
{
#define RAIN_CEC_VID  0x0483   // STMicroelectronics
#define RAIN_CEC_PID  0x5740
#define RAIN_CEC_VID2 0x04D8   // RainShadow
#define RAIN_CEC_PID2 0xFF59
  
  class CRainAdapterDetection
  {
  public:
