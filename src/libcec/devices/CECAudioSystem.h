...
namespace CEC
{
  ...
  public:
    ...
    bool TransmitSystemAudioModeRequest(const cec_logical_address source, uint16_t phys, bool bIsReply);
    ...
    uint8_t SystemAudioModeRequest(const cec_logical_address source, bool bOnOff = true);
